...
void test_dynamic() {
	...
	/*parameters*/
	int iteration_graph_times = 10, iteration_source_times = 10, iteration_terminal_times = 10;
	int V = 100, E = 500, precision = 1, thread_num = 1;//原来是10，先开成1
	...
	for (int i = 0; i < iteration_graph_times; i++) {
		...
		int generate_new_graph = 1; // this value is for debug (set to 0: won't create new graph)
